...
SECRET_KEY = 'django-insecure-)$y6!$2ihlm3b6*(4_45nxc^j$q7rxe)+-hhhzhr$id$!*n$9^'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR/'templates'],  #redirects to templates folder
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
CSRF_COOKIE_SECURE = False          # because you're on HTTP, not HTTPS
CSRF_COOKIE_HTTPONLY = False        # not strictly required but helps
